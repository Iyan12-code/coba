...
__export(components_exports, {
  ...
  CFocusTrap: () => CFocusTrap,
  CFocusTrapPlugin: () => CFocusTrapPlugin,
  CFooter: () => CFooter,
...
var getReferenceElement = (reference2, dropdownToggleRef, dropdownRef) => {
  ...
  if (reference2 instanceof Object && "value" in reference2) {
    return reference2.value;
  }
  return dropdownToggleRef.value;
};

// node_modules/@coreui/vue/dist/esm/components/focus-trap/utils.js
...
var isElement2 = (object2) => {
  ...
  return "nodeType" in object2 && typeof object2.nodeType === "number";
};
...
// node_modules/@coreui/vue/dist/esm/components/focus-trap/CFocusTrap.js
var CFocusTrap = defineComponent({
  name: "CFocusTrap",
  props: {
    /**
  ...
  setup(props, { emit, slots, expose }) {
    ...
    const activateTrap = () => {
      ...
      handleFocusIn = (event) => {
        ...
        if (additionalContainer && (target === additionalContainer || additionalContainer.contains(target))) {
          return;
        }
        const elements = focusableChildren(container);
        if (elements.length === 0) {
  ...
  setup(props, { slots, emit }) {
    ...
    watch(visible, () => {
      if (visible.value && dropdownToggleRef.value && dropdownMenuRef.value) {
        ...
        if (referenceElement && popper2.value) {
    ...
    const handleClick = (event) => {
      ...
      if (props.autoClose === true || props.autoClose === "inside" && isOnMenu || props.autoClose === "outside" && !isOnMenu) {
        setVisible(false);
      }
    };
    ...
    return () => h(CFocusTrap, { active: props.teleport && visible.value, additionalContainer: dropdownMenuRef }, () => props.variant === "input-group" ? [slots.default && slots.default()] : h("div", {
      class: [
...
var CDropdownToggle = defineComponent({
  ...
  setup(props, { slots }) {
    ...
    }, () => props.split ? h("span", { class: "visually-hidden" }, props.splitLabel) : slots.default && slots.default());
  }
});
...
// node_modules/@coreui/vue/dist/esm/components/focus-trap/index.js
var CFocusTrapPlugin = {
  install: (app) => {
    app.component(CFocusTrap.name, CFocusTrap);
  }
};
