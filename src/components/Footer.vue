        ...
        <div class="mx-20">
          ...
          <ul class="space-y-3">
            <li v-for="link in companyLinks" :key="link.name">
              <a 
                href="#"
                class="text-gray-400 font-poppins text-2xl hover:text-white transition-colors font-medium"
              >
                {{ link.name }}
              </a>
            </li>
        ...
        <div>
          ...
          <ul class="space-y-4">
            <li class="flex items-start gap-3 text-gray-400">
              <svg class="w-7 h-7  mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"></path>
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"></path>
              </svg>
              <span class="leading-relaxed text-2xl font-medium font-poppins">
            ...
            <li>
              <a 
                href="#"
                class="flex items-center gap-3 text-gray-400 hover:text-white transition-colors font-poppins"
              >
                ...
                <span class="font-medium font-poppins text-xl">+62 21 1234 5678</span>
              </a>
            </li>
            ...
            <li>
              <a 
                href="#"
                class="flex items-center gap-3 font-poppins text-gray-400 hover:text-white transition-colors"
              >
                <svg class="w-7 h-7  flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path>
                </svg>
                <span class="font-medium font-poppins text-2xl">123@deckalima.com</span>
              </a>
            </li>
          </ul>
        </div>
...
const socialMedia = ref([
  {
    name: 'Facebook',
    icon: '/assets/sosmed/facebook.png'
  },
  {
    name: 'Instagram',
    icon: '/assets/sosmed/instagram 3.png'
  },
  {
    name: 'Twitter',
    icon: '/assets/sosmed/twitter 3.png'
  },
  {
    name: 'TikTok',
    icon: '/assets/sosmed/tik-tok.png'
  }
])
</script>
